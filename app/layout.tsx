  ...
  return (
    <html lang="en">
      <body className="min-h-screen bg-planit text-emerald-50">
        {/* Üst Navbar */}
        <header className="w-full border-b border-emerald-500/20 bg-black/25 backdrop-blur">
        ...
        <main className="max-w-5xl mx-auto px-4 py-10">
          <div className="rounded-3xl bg-black/40 border border-emerald-500/15 shadow-[0_18px_60px_rgba(0,0,0,0.6)] p-6 sm:p-8">
            {children}
          </div>
        </main>
      </body>
